package com.example.application.views.food;
...
@PageTitle("Food")
@CssImport("./styles/views/food/food-view.css")
public class FoodView extends Div {
    ...
    public FoodView(@Autowired FoodProductService foodProductService) {
        setId("food-view");
        // Create UI
